package com.alchemy.framingtools.common.item;

import static com.alchemy.framingtools.common.util.Translate.*;
...
public class ItemHandFramingTool extends Item implements IFrameable {
    ...
    @Override
    @Optional.Method(modid = Values.STORAGE_DRAWERS_MODID)
